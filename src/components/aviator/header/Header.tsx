...
import logo from "@/../public/assets/aviator/logo.svg";
// import refound from "@/../public/assets/aviator/remove.png";
import "../../../index.scss";
import "./header.scss";
...
const Header = () => {
  ...
  const [howto, setHowto] = useState<"howto" | "short" | "more" | "">("howto");
          ...
          {/* {state.userInfo.userType && (
            <div className="center" onClick={Refound}>
              ...
              <button className="refound">
                <Image width={23} src={refound} alt="refound"></Image>
              </button>
            </div>
          )} */}
